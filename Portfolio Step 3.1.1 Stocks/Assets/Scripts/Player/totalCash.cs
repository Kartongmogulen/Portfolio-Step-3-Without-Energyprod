...
public class totalCash : MonoBehaviour
{
	...
	public float moneyTransaction(float moneyTransaction)
	{
		moneyNow += moneyTransaction;
	...
	{
		moneyNow = MoneyManager.moneyTransaction(moneyNow, 100f);

	}

	public void incomeWork()
	{
		moneyNow = MoneyManager.moneyTransaction(moneyNow, GetComponent<playerIncomeWork>().incomeWork);
		updateMoney();
		/*
	...
	*/
	...
	public void incomeDividend()
	{
		moneyBefore = moneyNow;
		moneyNow = moneyBefore + playerPanelGo.GetComponent<portfolio>().dividendPerYear;
		moneyText.text = "Money: " + moneyNow;
		moneyBefore = moneyNow;
		incomeTotDivBefore = incomeTotDivNow;
		incomeTotDivNow = incomeTotDivBefore + playerPanelGo.GetComponent<portfolio>().dividendPerYear;
		incomeTotDivBefore = incomeTotDivNow;
	}
